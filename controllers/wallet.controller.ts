...
exports.getWalletByAddress = async function (req: Request, res: Response) {
...
exports.createWallet = async function (req: Request, res: Response) {
  if (
    req.body === undefined ||
...
exports.updateBalanceByAddress = async function (req: Request, res: Response) {
  if (
...
exports.getTokenPrice = async function (req: Request, res: Response) {
  try {
